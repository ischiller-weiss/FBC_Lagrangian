...
python experiment.py --release_start 2016-01-01T00:00:00 --release_end 2020-12-31T00:00:00 --seeding uniform --frequency 5D --output_dir ../data/uniform_release_clim_land_nans/
