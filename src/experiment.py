...
if __name__ == "__main__":
    ...
    cluster = dask_jobqueue.SLURMCluster(
        ...
        job_extra_directives=[
            ...
            "--exclude=nesh-clk[345,351,352,356,358,363,366,375,377,384-387,390-392,394,396,398,402,406,408,414-416,428,429,431,433-434,438,440,444-446,452,454,456,459,462,468-470,472,476,479,480,483,493,502,511,515,529,536,538,546,553,555,557,558,560,562,564,566,570,573,574,579,584,586-587,594,598,602]",
        ],
