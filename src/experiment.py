...
if __name__ == "__main__":
    ...
    cluster = dask_jobqueue.SLURMCluster(
        ...
        job_extra_directives=[
            ...
            "--exclude=nesh-clk[345,351,352,356,358,363,366,377,384,385,387,390-392,394,396,398,402,414-416,428,433-434,438,440,445-446,454,456,459,469-470,479,483,493,502,511,515,529,536,538,555,557,558,570,573,579,586-587,594,598,602]",
        ],
